    ...
    return {
        ...
        init: function () {
            ...
            var treeDataSource1 = new DataSourceTree({
                data: [
                    { name: '一级目录1', type: 'folder', 'icon-class': 'gold  ', additionalParameters: { id: 'F1' } },
                    { name: '一集目录2', type: 'folder', 'icon-class': 'gold', additionalParameters: { id: 'F2' } },
                    { name: '<i class="fa fa-folder-open-o gold"></i> 二级目录1', type: 'item', additionalParameters: { id: 'I11' } },
                    { name: '<i class="fa fa-folder-open-o gold"></i> 二级目录2', type: 'item', additionalParameters: { id: 'I12' } },
                    { name: '<i class="fa fa-folder-open-o gold"></i> 二级目录3', type: 'item', additionalParameters: { id: 'I13' } }
                ],
                delay: 400
            });
