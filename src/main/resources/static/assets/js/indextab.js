...
//              $.loading(false);
        ...
        closeOtherTabs: function () {
            $('.page-tabs-content').children("[data-id]").find('.fa-times').parents('a').not(".active").each(function () {
...
//              });
        ...
        init: function () {
            ...
            $('.tabCloseAll').on('click', function () {
                $('.page-tabs-content').children("[data-id]").find('.fa-times').each(function () {
                    $('.NFine_iframe[data-id="' + $(this).data('id') + '"]').remove();
    ...
    //顶部切换
    $('.navtab-hd .navtab-item').click(function() {
    	var id = $(this).attr('data-id');
    	if(!$(this).hasClass('active')) {
			$('.navtab-bd .navtab-item').each(function(index, item) {
				console.log($(item).data('id'))
				if($(item).data('id') === id) {
					$('.navtab-bd .navtab-item').removeClass('active').eq(index).addClass('active');
				}
			})
	    	$('.navtab-hd .navtab-item, .navtab-submenu').removeClass('active');
			
	        $(this).addClass('active');
			if($(this).parent().hasClass('navtab-submenu')) {
