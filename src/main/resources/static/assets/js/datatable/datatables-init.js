    ...
    return {
        init: function () {
            ...
            jQuery('#simpledatatable .group-checkable').change(function () {
                var set = $("#simpledatatable .checkboxes");
...
var InitiateEditableDataTable = function () {
    return {
        init: function () {
            ...
            //Check All Functionality
            jQuery('#editabledatatable .group-checkable').change(function () {
                var set = $("#editabledatatable .checkboxes");
                var checked = jQuery(this).is(":checked");
                jQuery(set).each(function () {
                    if (checked) {
                        $(this).prop("checked", true);
            ...
            jQuery('#editabledatatable tbody tr .checkboxes').change(function () {
                $(this).parents('tr').toggleClass("active");
            });
            ...
            $('#editabledatatable_new').click(function (e) {
                ...
                var aiNew = oTable.fnAddData(['', '', '', '', '',
                        '<a href="#" class="btn btn-success btn-xs save"><i class="fa fa-save"></i> 保存</a> <a href="#" class="btn btn-warning btn-xs cancel"><i class="fa fa-times"></i> 取消</a>'
                ]);
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[5].innerHTML = '<a href="#" class="btn btn-success btn-xs save"><i class="fa fa-save"></i> 保存</a> <a href="#" class="btn btn-warning btn-xs cancel"><i class="fa fa-times"></i> 取消</a>';
            }
